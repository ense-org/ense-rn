...
export default class TestPlayback extends React.Component {
  constructor(props) {
    super(props);
    this.index = 0;
  ...
  async _loadNewPlaybackInstance(playing) {
    if (this.playbackInstance != null) {
      ...
      this.playbackInstance.onPlaybackStatusUpdate = null;
      this.playbackInstance = null;
    }
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.timestampRow}>
            <Text style={[styles.text, styles.buffering, { fontFamily: 'Courier New' }]}>
              {this.state.isBuffering ? BUFFERING_STRING : ''}
            </Text>
            <Text style={[styles.text, styles.timestamp, { fontFamily: 'Courier New' }]}>
              {this._getTimestamp()}
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.buttonsContainerBase, styles.buttonsContainerBottomRow]}>
          ...
          >
            <View style={styles.button}>
              <Text style={[styles.text, { fontFamily: 'Courier New' }]}>Rate:</Text>
            </View>
          </TouchableHighlight>
          <Slider
        ...
        {this.state.showVideo ? (
          <View>
            <View style={[styles.buttonsContainerBase, styles.buttonsContainerTextRow]}>
              ...
              >
                <View style={styles.button}>
                  <Text style={[styles.text, { fontFamily: 'Courier New' }]}>Fullscreen</Text>
                </View>
              </TouchableHighlight>
              <View />
            </View>
